...
public:
    ...
    ESKF(Matrix<float, 19,1> initialState, Vector3f sig2_a_n_, Vector3f sig2_omega_n_,Vector3f sig2_a_w_, Vector3f sig2_omega_w_);
    ESKF();
    ...
    void updateStateAbsPos(Vector3f pos, Quaternion<float> rot);
//private:
    ...
    Vector3f sig2_a_n;
    Vector3f sig2_a_w;
    Vector3f sig2_omega_n;
    Vector3f sig2_omega_w;
